;;; fcitx5.scm --- The Koxia Guix Channel  -*- mode: scheme; -*-
;;;
;;; SPDX-License-Identifier: GPL-3.0-or-later
;;;
;;; This file is generated from koxia-fcitx5.org.
;;; Do not modify manually.

(define-module (koxia packages fcitx5)
...
The upstream @file{default.yaml} is included as
@file{wanxiang_suggested_default.yaml}.  To enable it, please modify your
@file{default.custom.yaml} as such:
